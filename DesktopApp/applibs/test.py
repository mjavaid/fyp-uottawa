...
class scrollableContainer(Frame):
    ...
    def __init__(self, master, **kwargs):
        ...
        self.hScroll = Scrollbar(self, orient='horizontal',command=self.canv.xview)
        ...
        self.canv.configure(xscrollcommand=self.hScroll.set,yscrollcommand=self.vScroll.set)
